...
questions = [
    ...
    Question(
        ...
        correct_answer_index=3),
    Question(
        title='Пирамидинг в управлении позицией – это...',
        answers=[
            'Стратегия открытия сделки по тренду и последующего открытия в обратную сторону',
            'Стратегия увеличения позиции после каждого движения цены в нужную сторону',
            'Резкое сокращение размера позиции после первой прибыли',
            'Установка нескольких тейк-профитов в одну точку',
        ],
        correct_answer_index=1),
    Question(
        title='Сколько волн содержит базовая структура импульса в волновом анализе Эллиотта?',
        answers=[
            '5',
            '7',
            '3',
        ...
        correct_answer_index=0),
    Question(
        title='Что такое "ликвидация" во фьючерсном трейдинге?',
        answers=[
            'Добровольное закрытие позиции трейдером',
            'Продажа всех активов при достижении цели',
            'Сжигание токенов на спотовом счете',
            'Автоматическое закрытие позиции биржей при достижении определенного убытка',
        ],
        correct_answer_index=3),
    Question(
        title='Термин "ретест" в техническом анализе означает...',
        answers=[
            'Повторный тест уровня после пробоя',
            'Смену тренда на противоположный',
            'Резкий отскок от линии сопротивления',
            'Повторное касание 50 уровня RSI',
        ],
        correct_answer_index=0),
    Question(
        title='Что из перечисленного не относится к видам ордеров?',
        answers=[
            'Лимитный',
            'Рыночный',
            'Тейковый',
        ...
        correct_answer_index=2),
    Question(
        title='Что такое "уровни ликвидности"?',
        answers=[
            'Участки, где цена всегда отскакивает',
            'Места, где находятся крупные отложенные ордера',
            'Зоны, где цена никогда не останавливается',
            'Индикаторы, указывающие на перекупленность',
        ],
        correct_answer_index=1),
    Question(
        title='Что такое "проскальзывание" при исполнении ордера?',
        answers=[
            'Резкое движение цены до открытия сделки',
            'Разница между ожидаемой и фактической ценой исполнения',
            'Частичное исполнение ордера',
            'Задержка отображения цены на графике',
        ],
        correct_answer_index=1),
    Question(
        title='Что представляет собой коррекционная структура ABC в волновом анализе?',
        answers=[
            'Трехволновое движение против основного тренда',
            'Трехволновое движение по тренду',
            'Волновую разворотную фигуру с объемами',
            'Импульсное волновое движение на младшем ТФ',
        ],
        correct_answer_index=0),
    Question(
        title='Какая из этих фигур наиболее часто встречается на консолидации?',
        answers=[
            'Вымпел',
            'Двойное дно',
            'Чашка с ручкой',
    ...
    Question(
        ...
        answers=[
            ...
            'Сумма возможной прибыли в сделке',
            'Процент от депозита, которым готов рискнуть трейдер',
            'Максимальный объем входа',
        ],
        correct_answer_index=2),
    Question(
        title='PNL в трейдинге это...',
        answers=[
            'Показатель настроения рынка',
            'Текущая прибыль или убыток по открытым сделкам',
            'Объем торгов на бирже',
            'Коэффициент заемных средств',
        ],
        correct_answer_index=1),
    Question(
        title='Какой из индикаторов указывает на дивергенцию?',
        answers=[
            'RSI',
            'Bollinger Bands',
            'MA200',
        ...
        correct_answer_index=0),
    Question(
        title='Какой из паттернов сигнализирует о нерешительности рынка?',
        answers=[
            'Молот',
            'Бычий флаг',
            'Двойная вершина',
        ...
        correct_answer_index=3),
    Question(
        title='Какой принцип лежит в основе волнового анализа?',
        answers=[
            'Уникальность каждого движения',
            'Технические индикаторы',
            'Случайность рыночных импульсов',
            'Повторяемость и цикличность поведения толпы',
        ],
        correct_answer_index=3),
    Question(
        title='В какой волне Эллиотта чаще всего происходит самое сильное движение цены?',
        answers=[
            'Волна 2',
            'Волна 4',
            'Волна 3',
        ...
        correct_answer_index=2),
    Question(
        title='Что означает термин "риск/профит 1 к 3"?',
        answers=[
            'Трейдер планирует три сделки с одним стопом',
            'Объем позиции увеличен в три раза',
            'Возможная прибыль в три раза больше потенциального убытка',
            'Трейдер разделил сделку на три части',
        ],
        correct_answer_index=2),
    Question(
        title='Что такое зона консолидации?',
        answers=[
            'Момент выхода из сделки',
            'Пробой ключевого уровня',
            'Место, где ликвидность резко падает',
            'Период накопления, когда цена колеблется в узком диапазоне',
        ],
        correct_answer_index=3),
    Question(
        title='Что означает термин ATH в криптотрейдинге?',
        answers=[
            'Исторически максимальная цена актива',
            'Откат цены после импульса',
            'Автоматическая торговая стратегия',
            'Сигнал на продажу',
        ],
        correct_answer_index=0),
    Question(
        title='Как называется ситуация, когда трейдер заходит в сделку из-за страха упустить рост?',
        answers=[
            'DCA',
            'ROI',
            'FOMO',
        ...
        correct_answer_index=2),
    Question(
        title='Что такое Fair Value Gap (FVG)?',
        answers=[
            'Уровень, где цена долго стояла без движения',
            'Модель поведения цены с большими тенями',
            'Незаполненный участок между свечами, где не было торгов, создающий потенциальную цель для цены',
            'Место, где RSI пересекает уровень 50',
        ],
        correct_answer_index=2),
    Question(
        title='Что такое "Ордер-блок"?',
        answers=[
            'Индикатор перекупленности',
            'Уровень, где трейдер поставил тейк-профит',
            'Любая свеча с длинной тенью',
            'Область, где крупный игрок открывал или защищал позицию, оставив за собой заметный след на графике',
        ],
        correct_answer_index=3),
    Question(
        title='Что означает выражение "поход за стопами"?',
        answers=[
            'Манипулятивное движение цены за уровни стоп-ордеров с целью их активации',
            'Массовое открытие сделок в одном направлении',
            'Переход на другой таймфрейм',
            'Появление дивергенции на индикаторе',
        ],
        correct_answer_index=0),
    Question(
        title='Какую реакцию на графике мы ожидаем при ретесте ордер-блока?',
        answers=[
            'Локальный отскок или разворот, так как там ранее был крупный интерес',
            'Долгий флэт',
            'Резкий пробой и импульс вверх',
            'Незначительное движение вниз',
        ],
        correct_answer_index=0),
    Question(
        title='Что означает термин "аккумуляция" в контексте диапазона?',
        answers=[
            'Резкий памп без объема',
            'Фаза, в которой крупные игроки набирают позицию в узком диапазоне до основного движения',
            'Момент, когда рынок становится слишком волатильным',
            'Низкий интерес к активу',
        ],
        correct_answer_index=1),
    Question(
        title='Что считается эталонным (оптимальным) закрытием Fair Value Gap (FVG)?',
        answers=[
            'Любое касание зоны FVG',
            'Полное закрытие гэпа',
            'Когда FVG перекрыт свечами одного цвета',
            'Закрытие на 50% диапазона гэпа',
        ],
        correct_answer_index=3),
    Question(
        title='Что такое "недостаток ликвидности" (liquidity void)?',
        answers=[
            'Область с наибольшими объёмами торгов',
            'Уровень, на котором происходят чаще всего развороты',
            'Зона, где цена двигалась без встречных ордеров — почти без проторговки',
            'Уровень, где образуются ложные пробои',
        ],
        correct_answer_index=2),
    Question(
        title='Чем кросс-маржа отличается от изолированной маржи?',
        answers=[
            'В кроссе используется общий баланс, в изоле — только выделенная сумма',
            'В кроссе максимальное плечо ниже',
            'При изолированной марже комиссии ниже',
            'В кроссе нельзя использовать стоп-лосс, а в изолированной можно',
        ],
        correct_answer_index=0),
    Question(
        title='Какое плечо означает, что трейдер торгует в 10 раз большим объёмом, чем у него есть?',
        answers=[
            '0.1x',
            '1x',
            '10x',
        ...
        correct_answer_index=2),
    Question(
        title='Что происходит с рисками при увеличении плеча?',
        answers=[
            'Риски уменьшаются, так как задействовано меньше собственных средств',
            'Риски не меняются',
            'Риски возрастают – убыток может наступить быстрее',
            'Ликвидация становится невозможной',
        ],
        correct_answer_index=2),
    Question(
        title='Какая волна является коррекционной в базовой импульсной структуре Эллиотта?',
        answers=[
            'Волна 1',
            'Волна 2',
            'Волна 3',
